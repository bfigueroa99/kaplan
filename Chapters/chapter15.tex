...
\begin{tikzpicture}
    ...
    % Present
    \draw[thick] (0,0.2) -- (0,-0.2) node[below] {Present};

    % Future
    \draw[thick] (2,0.2) -- (2,-0.2) node[below] {Future};

    % Future Perfect
    \draw[thick] (6,0.2) -- (6,-0.2) node[below] {Future Perfect};

    % Future Continuous
    \draw[thick] (10,0.2) -- (10,-0.2) node[below] {Future Continuous};
