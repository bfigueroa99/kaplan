...
% Using DejaVu Sans as fallback font which is widely available in CI environments
...
% IPA Phonetic Symbols - handled natively by XeLaTeX with proper fonts
% If needed, use \textipa commands from tipa package
