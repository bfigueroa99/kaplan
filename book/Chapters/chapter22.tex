...
\section{Detailed Verb Patterns}

\begin{spanishbox}[title=⚠️ Para Hispanohablantes: Verbos que Cambian de Significado]
\textbf{Dificultad clave:} En español, el significado no cambia con infinitivo. En inglés, estos verbos tienen significados COMPLETAMENTE diferentes con gerundio vs infinitivo.

\textbf{Contrastes críticos:}
\begin{itemize}
    \item \textbf{STOP + -ing} = Dejar de hacer algo (terminar acción)
    \begin{itemize}
        \item ✓ "I stopped smoking" = Dejé de fumar (ya no fumo)
    \end{itemize}
    \item \textbf{STOP + to} = Parar para hacer otra cosa (propósito)
    \begin{itemize}
        \item ✓ "I stopped to smoke" = Paré para fumar (hice una pausa)
    \end{itemize}
    \item \textbf{REMEMBER + -ing} = Recordar algo del pasado (memoria)
    \begin{itemize}
        \item ✓ "I remember going" = Recuerdo haber ido (pasado)
    \end{itemize}
    \item \textbf{REMEMBER + to} = Acordarse de hacer algo (futuro/obligación)
    \begin{itemize}
        \item ✓ "Remember to bring" = Acuérdate de traer (no olvides)
    \end{itemize}
    \item \textbf{TRY + -ing} = Experimentar/probar (método nuevo)
    \begin{itemize}
        \item ✓ "Try swimming" = Prueba a nadar (experimenta)
    \end{itemize}
    \item \textbf{TRY + to} = Intentar con esfuerzo (objetivo difícil)
    \begin{itemize}
        \item ✓ "Try to finish" = Intenta terminar (haz el esfuerzo)
    \end{itemize}
\end{itemize}

\textbf{💡 Truco:} STOP/REMEMBER/TRY + gerundio = acción real/pasada. STOP/REMEMBER/TRY + infinitivo = acción nueva/futura.
\end{spanishbox}
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Hate + Both Gerund and Infinitive} (Both are correct)
    \begin{itemize}
        \item He hates \textbf{waiting}. / He hates \textbf{to wait}.
        \item They hate \textbf{cleaning} the house. / They hate \textbf{to clean} the house.
    \end{itemize}
    \item \textbf{Like + Both Gerund and Infinitive} (Both are correct)
    \begin{itemize}
        \item I like \textbf{jogging}. / I like \textbf{to jog}.
        \item We like \textbf{traveling}. / We like \textbf{to travel}.
    \end{itemize}
    \item \textbf{Start + Both Gerund and Infinitive} (Both are correct)
    \begin{itemize}
        \item She started \textbf{learning} Spanish. / She started \textbf{to learn} Spanish.
        \item They started \textbf{working} on the project. / They started \textbf{to work} on the project.
    \end{itemize}
...
\begin{tcolorbox}[colback=red!5, colframe=red!30, title=Stop]
...
\begin{tcolorbox}[colback=green!5, colframe=green!30, title=Forget]
...
\begin{tcolorbox}[colback=yellow!5, colframe=yellow!30, title=Remember]
...
\begin{tcolorbox}[colback=orange!5, colframe=orange!30, title=Try]
...
\begin{tcolorbox}[colback=purple!5, colframe=purple!30, title=Effort]
...
\begin{tcolorbox}[colback=red!5, colframe=red!30, title=Regret]
...
\section{Writing and Discussion}

\subsection{Creative Writing: Christmas Story}
...
\subsection{Discussion: Future Dreams}

\textbf{What are your 3 biggest dreams for the future?}
...
\textbf{a) Why is it sometimes hard to follow your dreams?}
...
\textbf{b) Do your family/friends support your dreams?}

\begin{tcolorbox}[colback=white,height=4cm]
\end{tcolorbox}

\textbf{c) Have you ever felt pressured to follow someone else's expectations?}
...
\begin{itemize}
    \item \href{https://learnenglish.britishcouncil.org/grammar/b1-b2-grammar/verbs-followed-by-ing-or-infinitive-1}{British Council LearnEnglish}
    \item \href{https://test-english.com/grammar-points/b1/gerund-or-infinitive/}{Test-English}
    \item \href{https://www.perfect-english-grammar.com/gerunds-and-infinitives-exercise-1.html}{Perfect English Grammar}
\end{itemize}
