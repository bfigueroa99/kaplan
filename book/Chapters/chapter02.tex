...
\begin{britishbox}[title=🇬🇧 British Cinema and Entertainment]
\textbf{Did you know?}
\begin{itemize}
    \item British people say \textbf{"the cinema"} (not "the movies")
    \item James Bond films are iconic British productions - 007 has been played by several British actors
    \item Popular British weekend activities include: going to the pub, watching football, visiting museums, or having a "Sunday roast"
    \item When British people had a cold, they often say they \textbf{"weren't feeling well"} or were \textbf{"under the weather"}
\end{itemize}
\textbf{Fun fact:} The British film industry is called "British cinema" and includes famous franchises like James Bond, Harry Potter, and The Lord of the Rings!
\end{britishbox}
