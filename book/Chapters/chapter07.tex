...
\section{Additional Modals: Advice, Obligation and Probability}

\subsection{Advice: Should and Ought to}
\begin{itemize}
    \item \textbf{Should:} Describes the ideal or best thing to do.
    \item \textbf{Ought to:} Describes something we want to happen (often allows for moral obligation).
\end{itemize}
\begin{examplebox}[title=Examples]
\begin{itemize}
    \item There \textbf{should} be many more green jobs.
    \item Governments \textbf{really ought to} tax the big polluters.
\end{itemize}
\end{examplebox}

\subsection{Necessity: Must}
\begin{itemize}
    \item \textbf{Must:} Describes something we see as necessary or a logical deduction.
\end{itemize}
\begin{examplebox}[title=Example]
\begin{itemize}
    \item There \textbf{must} be global action on climate change now.
\end{itemize}
\end{examplebox}

\subsection{Probability and Expectations}
\begin{itemize}
    \item \textbf{Can:} Used to talk about general truths and tendencies.
    \item \textbf{Should be + -ing:} Describes something we expect to be happening.
    \item \textbf{May + adverbs:} Often used with \textit{never, just, only}.
\end{itemize}
\begin{examplebox}[title=Examples]
\begin{itemize}
    \item As a nation we \textbf{can} provide better jobs.
    \item Global temperatures \textbf{should be falling} in the next 15 years.
    \item We \textbf{may only see} the results in 20 years.
\end{itemize}
\end{examplebox}
