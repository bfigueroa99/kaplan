...
\begin{comparisonbox}[title=🇪🇸 Futuros Avanzados: Español vs Inglés]
\textbf{⚠️ Español simplifica - Inglés distingue CUÁNDO en el futuro}

\textbf{1. Español - Futuro simple para todo:}
\begin{itemize}
    \item "Estaré trabajando mañana a las 3" (acción en progreso)
    \item "Habré terminado para el viernes" (acción completada)
    \item "Habré estado trabajando 6 meses" (duración hasta un punto)
    \item Español usa perífrasis verbales pero más flexiblemente
\end{itemize}

\textbf{2. Inglés - 3 futuros avanzados diferentes:}
\begin{itemize}
    \item \textbf{Future Continuous} (WILL BE + -ING)
    \begin{itemize}
        \item "I\textbf{'ll be working} at 3pm tomorrow" ✓
        \item Acción EN PROGRESO en un momento específico futuro
    \end{itemize}
    \item \textbf{Future Perfect} (WILL HAVE + PAST PARTICIPLE)
    \begin{itemize}
        \item "I\textbf{'ll have finished} by Friday" ✓
        \item Acción COMPLETADA antes de un momento futuro
    \end{itemize}
    \item \textbf{Future Perfect Continuous} (WILL HAVE BEEN + -ING)
    \begin{itemize}
        \item "I\textbf{'ll have been working} for 6 months" ✓
        \item DURACIÓN hasta un momento futuro
    \end{itemize}
\end{itemize}

\textbf{3. Regla clave - ¿QUÉ pregunto?}
\begin{center}
\textbf{"¿Qué estarás haciendo?"} → Future Continuous\\
\textbf{"¿Lo habrás terminado?"} → Future Perfect\\
\textbf{"¿Cuánto tiempo llevarás?"} → Future Perfect Continuous
\end{center}

\textbf{4. Errores comunes de hispanohablantes:}
\begin{itemize}
    \item ❌ "I will work at 3pm" (demasiado simple)
    \item ✓ "I\textbf{'ll be working} at 3pm" (acción en progreso)
    \item ❌ "I will finish by Friday" (no enfatiza completitud)
    \item ✓ "I\textbf{'ll have finished} by Friday" (énfasis en completado)
\end{itemize}

\textbf{💡 Para hispanohablantes:}
\begin{itemize}
    \item BY (para) = Future Perfect → "By 5pm, I'll have finished"
    \item AT (a las) = Future Continuous → "At 5pm, I'll be working"
    \item FOR (durante) = Future Perfect Continuous → "I'll have been working for 5 hours"
\end{itemize}
\end{comparisonbox}
