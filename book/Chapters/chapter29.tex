...
\begin{tcolorbox}[colback=blue!5, colframe=blue!30, title=Sample Answers]
\textbf{Example 1:} Someone you look up to

"If I need to choose one person, it would be Linus Torvalds because he is the father of Linux operating system \textbf{which} is widely used around the world. He is a great programmer and innovator."

\textbf{Example 2:} A place where you would love to live

"I would love to live in the south of Chile one day because of its beautiful landscapes, mountains, and lakes."

\textbf{Example 3:} A song you love and dislike

"A song \textbf{which} I love is 'The Song Inside of Me', is a punk rock song that always energizes me. A song I dislike is 'Baby Shark' because of its repetitive and annoying tune."

\textbf{Example 4:} A thing you could never live without

"A thing \textbf{that} I could never live without is a good bed."
\end{tcolorbox}

\subsection{Exercise 6: Complete with Correct Relative Pronoun}
Fill in the blanks with the appropriate relative pronoun:

\begin{enumerate}
    \item[a)] The car, \_\_\_\_\_\_ is very expensive, belongs to my neighbor.
    \item[b)] The man \_\_\_\_\_\_ car was stolen called the police.
    \item[c)] The teacher \_\_\_\_\_\_ teaches us English is from London.
    \item[d)] The students \_\_\_\_\_\_ study hard usually get good grades.
    \item[e)] The restaurant \_\_\_\_\_\_ we had dinner last night was excellent.
    \item[f)] This is the city \_\_\_\_\_\_ I was born.
\end{enumerate}

\textit{Answers: a) which, b) whose, c) who, d) who, e) where, f) where}
...
\section{Advanced Practice: Describing Places}

\subsection{Exercise 7: Descriptive Writing with Relative Clauses}

Use relative clauses to make your descriptions more sophisticated. Here's an example of how to describe a beautiful location:

\begin{tcolorbox}[colback=green!5, colframe=green!30, title=Writing Example: Torres del Paine]
\textbf{Task:} Describe a beautiful place you have visited.

\textbf{Sample Essay:}

One of the most beautiful places I have ever visited is Torres del Paine, \textbf{which} is a national park located in the south of Chile. The park, \textbf{which} features rocky snow-covered mountains, offers a spellbinding view \textbf{that} takes your breath away. The peaks, \textbf{which} stand against the clear blue sky, create a landscape \textbf{that} I will remember forever. It is a place \textbf{where} you can experience unique natural beauty and \textbf{where} adventure seekers find their paradise.
\end{tcolorbox}

\subsection{Exercise 8: Place Descriptions - Lake Bled}

Practice adding descriptive adjectives to places using relative clauses:

\begin{table}[h]
\centering
\begin{tabular}{|l|l|}
\hline
\textbf{Basic Description} & \textbf{Enhanced Description} \\
\hline
The lake at Bled & A freshwater lake \textbf{which} is crystal clear \\
\hline
Around the lake & Grassy meadow and rolling hills \textbf{that} surround it \\
\hline
The mountains north of the lake & Snow-covered mountains \textbf{which} tower above \\
\hline
The forest to the west & A mysterious dense forest \textbf{where} wildlife roams \\
\hline
The church on the island & A picturesque church \textbf{which} sits on the island \\
\hline
Bled Castle & A castle \textbf{that} is situated overlooking the lake \\
\hline
The views from the castle & Breathtaking views \textbf{which} attract tourists \\
\hline
\end{tabular}
\caption{Descriptive Practice with Relative Clauses}
\end{table}

\subsection{Exercise 9: Your Turn - Write About Your Accommodation}

Write a paragraph describing where you live using relative clauses. Include:
\begin{itemize}
    \item Location (WHERE it is situated)
    \item Features (WHICH/THAT describe it)
    \item Neighbors or people (WHO live nearby)
    \item Things you like/dislike (WHICH/THAT make it special)
\end{itemize}

\begin{tcolorbox}[colback=yellow!5, colframe=yellow!30, title=Sample: Student Accommodation]
I live in a student residence, \textbf{which} is located in Oxford. My room in this accommodation is small but cozy, \textbf{which} has a bed, a desk, and a little bathroom. I have a wardrobe \textbf{where} I hang my clothes and store my shoes. There is also a shelf near my desk, \textbf{which} I use to keep some things like folders and other items. On the wall there is a board \textbf{where} I can pin some notes and photos. Sometimes I listen to music from my neighbor, \textbf{who} practices saxophone, and it is really relaxing to hear. The only problem with my room is the windows, \textbf{which} do not open well, and the other problem is my height—I am very tall, and sometimes I hit my head on the shower.
\end{tcolorbox}
...
\begin{itemize}
    \item \href{https://learnenglish.britishcouncil.org/grammar/b1-b2-grammar/relative-clauses-defining-non-defining}{British Council LearnEnglish}
    \item \href{https://test-english.com/grammar-points/b1/relative-clauses-defining-non-defining/}{Test-English}
\end{itemize}
