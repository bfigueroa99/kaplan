...
\begin{comparisonbox}[title=🇪🇸 Pasiva en Español vs Inglés: MUY Diferente]
\textbf{⚠️ La pasiva en español es POCO usada. En inglés es COMÚN.}

\textbf{1. Español prefiere "SE":}
\begin{itemize}
    \item Español: "\textbf{Se habla} inglés aquí" (impersonal con SE)
    \item Español formal: "El inglés \textbf{es hablado} aquí" (raro, muy formal)
    \item English: "English \textbf{is spoken} here" (común y natural)
\end{itemize}

\textbf{2. Construcción diferente:}
\begin{itemize}
    \item Español: "\textbf{Fue construido} en 1850" (sin agente normalmente)
    \item English: "It \textbf{was built} in 1850" (con o sin "by someone")
\end{itemize}

\textbf{3. Inglés usa pasiva mucho más:}
\begin{itemize}
    \item Noticias: "The President \textbf{was elected}" (no "They elected the President")
    \item Ciencia: "The test \textbf{was performed}" (formal)
    \item Carteles: "Smoking \textbf{is prohibited}" (impersonal)
\end{itemize}

\textbf{💡 Para hispanohablantes:} Si en español dirías "SE + verbo", en inglés probablemente uses pasiva.
\begin{itemize}
    \item "Se venden casas" → Houses \textbf{are sold}
    \item "Se requiere experiencia" → Experience \textbf{is required}
\end{itemize}
\end{comparisonbox}
...
\begin{itemize}
    \item \href{https://learnenglish.britishcouncil.org/grammar/b1-b2-grammar/passives}{British Council LearnEnglish}
    \item \href{https://test-english.com/grammar-points/b1/passive-voice-all-tenses/}{Test-English}
    \item \href{https://www.perfect-english-grammar.com/passive-exercise-1.html}{Perfect English Grammar}
\end{itemize}
